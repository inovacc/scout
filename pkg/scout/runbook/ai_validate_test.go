...
func TestValidateWithLLM_ValidRunbook(t *testing.T) {
...
func TestValidateWithLLM_InvalidJSON(t *testing.T) {
	provider := &mockLLMProvider{
		name:      "mock",
		responses: map[string]string{"": "The runbook looks mostly good but could use pagination."},
	}
...
func TestValidateWithLLM_NilRunbook(t *testing.T) {
