...
func (b *Browser) WithPanic(fail func(any)) *Browser {
	n := *b
	n.e = genE(fail)
...
// The fail must stop the current goroutine's execution immediately, such as use [runtime.Goexit] or panic inside it.
func (p *Page) WithPanic(fail func(any)) *Page {
	n := *p
	n.e = genE(fail)
...
func (p *Page) MustExpose(name string, fn func(gson.JSON) (any, error)) (stop func()) {
...
func (p *Page) MustEval(js string, params ...any) gson.JSON {
...
func (p *Page) MustWait(js string, params ...any) *Page {
...
func (p *Page) MustElementByJS(js string, params ...any) *Element {
...
func (p *Page) MustElementsByJS(js string, params ...any) Elements {
...
// The fail must stop the current goroutine's execution immediately, such as use [runtime.Goexit] or panic inside it.
func (el *Element) WithPanic(fail func(any)) *Element {
	n := *el
	n.e = genE(fail)
...
func (el *Element) MustWait(js string, params ...any) *Element {
...
func (el *Element) MustEval(js string, params ...any) gson.JSON {
...
func (el *Element) MustElementByJS(js string, params ...any) *Element {
...
func (el *Element) MustElementsByJS(js string, params ...any) Elements {
