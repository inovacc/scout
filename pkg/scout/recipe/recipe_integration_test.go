...
func TestRecipePipeline_GenerateAndValidateSelectors(t *testing.T) {
...
func TestRecipePipeline_GenerateWithFragileSelectors(t *testing.T) {
	analysis := &SiteAnalysis{
...
func TestRecipePipeline_FixRecipeNoURL(t *testing.T) {
	r := &Recipe{
		Version: "1",
		Name:    "no-url",
		Type:    "extract",
...
func TestRecipePipeline_SampleExtractNoItems(t *testing.T) {
	r := &Recipe{
		Version: "1",
		Name:    "no-items",
		Type:    "extract",
...
func TestRecipePipeline_LoadSaveRoundTrip(t *testing.T) {
	original := &Recipe{
		Version: "1",
		Name:    "roundtrip-test",
		Type:    "extract",
...
func TestRecipePipeline_ValidateRecipeFormat(t *testing.T) {
	tests := []struct {
		name    string
		input   string
		wantErr string
...
func TestRecipePipeline_InteractiveWithNilBrowser(t *testing.T) {
...
func TestRecipePipeline_ScoreAndWarn(t *testing.T) {
	analysis := &SiteAnalysis{
