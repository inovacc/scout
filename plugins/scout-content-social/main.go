// scout-content-social is a Scout plugin providing content and social platform scraper modes.
package main
...
func main() {
	...
	for _, name := range []string{"twitter", "youtube", "notion", "gdrive", "sharepoint"} {
