...
func (e *ExpectElementError) Error() string {
	return fmt.Sprintf("expect js to return an element, but got: %s", utils2.MustToJSON(e))
}
...
func (e *ExpectElementsError) Error() string {
	return fmt.Sprintf("expect js to return an array of elements, but got: %s", utils2.MustToJSON(e))
}
...
func (e *ObjectNotFoundError) Error() string {
	return fmt.Sprintf("cannot find object: %s", utils2.MustToJSON(e))
}
