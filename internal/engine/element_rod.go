...
var (
	_ proto2.Client      = &rodElement{}
	_ proto2.Contextable = &rodElement{}
	_ proto2.Sessionable = &rodElement{}
)

// Element represents the DOM element.
type rodElement struct {
	Object *proto2.RuntimeRemoteObject
...
func (el *rodElement) ScrollIntoView() error {
	...
	return proto2.DOMScrollIntoViewIfNeeded{ObjectID: el.id()}.Call(el)
}
...
func (el *rodElement) Hover() error {
...
func (el *rodElement) MoveMouseOut() error {
	shape, err := el.Shape()
	if err != nil {
		return err
	}
	...
	return el.page.Mouse.MoveTo(proto2.NewPoint(box.X+box.Width, box.Y))
}
...
func (el *rodElement) Click(button proto2.InputMouseButton, clickCount int) error {
	err := el.Hover()
	if err != nil {
		return err
	}
...
func (el *rodElement) Interactable() (pt *proto2.Point, err error) {
...
//	/________/                                   /________/
func (el *rodElement) Shape() (*proto2.DOMGetContentQuadsResult, error) {
	return proto2.DOMGetContentQuads{ObjectID: el.id()}.Call(el)
}

// Type is similar with Keyboard.Type.
// Before the action, it will try to scroll to the element and focus on it.
func (el *rodElement) Type(keys ...input.Key) error {
	err := el.Focus()
	if err != nil {
		return err
	}
...
// Before the action, it will try to scroll to the element and focus on it.
func (el *rodElement) KeyActions() (*KeyActions, error) {
	err := el.Focus()
	if err != nil {
		return nil, err
	}
...
// Before the action, it will try to scroll to the element and focus on it.
func (el *rodElement) SelectText(regex string) error {
	err := el.Focus()
	if err != nil {
		return err
	}
...
// Before the action, it will try to scroll to the element and focus on it.
func (el *rodElement) SelectAllText() error {
	err := el.Focus()
	if err != nil {
		return err
	}
...
func (el *rodElement) Input(text string) error {
	err := el.Focus()
	if err != nil {
		return err
	}
...
func (el *rodElement) InputTime(t time.Time) error {
	err := el.Focus()
	if err != nil {
		return err
	}
...
// Before the action, it will scroll to the element, wait until it's visible, enabled and writable.
func (el *rodElement) InputColor(color string) error {
	err := el.Focus()
	if err != nil {
		return err
	}
...
func (el *rodElement) Select(selectors []string, selected bool, t SelectorType) error {
	err := el.Focus()
	if err != nil {
		return err
	}
...
func (el *rodElement) Matches(selector string) (bool, error) {
...
func (el *rodElement) Attribute(name string) (*string, error) {
...
// https://stackoverflow.com/questions/6003819/what-is-the-difference-between-properties-and-attributes-in-html
func (el *rodElement) Property(name string) (gson.JSON, error) {
...
func (el *rodElement) Disabled() (bool, error) {
...
func (el *rodElement) SetFiles(paths []string) error {
	absPaths := utils2.AbsolutePaths(paths)

	defer el.tryTrace(TraceTypeInput, fmt.Sprintf("set files: %v", absPaths))()

	el.page.browser.trySlowMotion()

	err := proto2.DOMSetFileInputFiles{
		Files:    absPaths,
		ObjectID: el.id(),
	}.Call(el)
...
func (el *rodElement) Describe(depth int, pierce bool) (*proto2.DOMNode, error) {
	val, err := proto2.DOMDescribeNode{ObjectID: el.id(), Depth: gson.Int(depth), Pierce: pierce}.Call(el)
	if err != nil {
		return nil, err
	}
...
func (el *rodElement) ShadowRoot() (*rodElement, error) {
	...
	shadowNode, err := proto2.DOMResolveNode{BackendNodeID: id}.Call(el)
	if err != nil {
		return nil, err
	}
...
func (el *rodElement) Frame() (*rodPage, error) {
	node, err := el.Describe(1, false)
	if err != nil {
		return nil, err
	}
	...
	clone.jsCtxID = new(proto2.RuntimeRemoteObjectID)
	clone.element = el
...
func (el *rodElement) ContainsElement(target *rodElement) (bool, error) {
...
func (el *rodElement) Text() (string, error) {
...
// HTML of the element.
func (el *rodElement) HTML() (string, error) {
	res, err := proto2.DOMGetOuterHTML{ObjectID: el.Object.ObjectID}.Call(el)
	if err != nil {
		return "", err
	}
...
func (el *rodElement) Visible() (bool, error) {
...
func (el *rodElement) WaitLoad() error {
...
func (el *rodElement) WaitStable(d time.Duration) error {
	err := el.WaitVisible()
	if err != nil {
		return err
	}
...
func (el *rodElement) WaitStableRAF() error {
	err := el.WaitVisible()
	if err != nil {
		return err
	}
	...
	var shape *proto2.DOMGetContentQuadsResult
...
func (el *rodElement) WaitInteractable() (pt *proto2.Point, err error) {
	defer el.tryTrace(TraceTypeWait, "interactable")()

	err = utils2.Retry(el.ctx, el.sleeper(), func() (bool, error) {
...
func (el *rodElement) WaitEnabled() error {
...
func (el *rodElement) CanvasToImage(format string, quality float64) ([]byte, error) {
...
func (el *rodElement) Resource() ([]byte, error) {
...
func (el *rodElement) BackgroundImage() ([]byte, error) {
...
func (el *rodElement) Screenshot(format proto2.PageCaptureScreenshotFormat, quality int) ([]byte, error) {
	err := el.ScrollIntoView()
	if err != nil {
		return nil, err
	}

	opts := &proto2.PageCaptureScreenshot{
	...
	return utils2.CropImage(bin, quality,
		int(box.X),
		int(box.Y),
		int(box.Width),
		int(box.Height),
...
func (el *rodElement) Release() error {
	return el.page.Context(el.ctx).Release(el.Object)
}

// Remove the element from the page.
func (el *rodElement) Remove() error {
...
func (el *rodElement) Call(ctx context.Context, sessionID, methodName string, params any) (res []byte, err error) {
