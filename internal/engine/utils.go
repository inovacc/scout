...
func (msg *Message) Load(e proto2.Event) bool {
	...
	utils2.E(json.Unmarshal(msg.data, e))
	msg.event = eVal
	msg.data = nil
...
func (sr *StreamReader) Close() error {
	return proto2.IOClose{Handle: sr.handle}.Call(sr.c)
}
...
func saveFile(fileType saveFileType, bin []byte, toFile []string) error {
	...
	return utils2.OutputFile(filepath.Join(toFile...), bin)
}
